...
with tab_input:
    ...
    n_op = st.sidebar.number_input('Numero operatori',value=1, step=1)
...
prodotti_finiti = st.sidebar.number_input('Macchine con output prodotto finito', step=1)
...
with tab_risultati:
    ...
    if turni != 0:
        ...
        for macchina in machines:
            ...
            st.write('Codice: _{}_   | Output per turno: :red[{:0.0f}] | Ta:{:0.2f} '.format(macchina.part, macchina.parts_made/turni, 450/(macchina.parts_made/turni)/prodotti_finiti*n_op))#-------------
